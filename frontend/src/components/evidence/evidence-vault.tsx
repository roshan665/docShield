...
export function EvidenceVault({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* REFERENCE PANEL 6: TOTAL EVIDENCE SUMMARY CARD & CATEGORY TILES */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
        {/* Total Evidence Summary Card */}
        <Card className="rounded-2xl border-slate-200/90 bg-white p-4 shadow-sm sm:col-span-2 lg:col-span-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <div className="text-2xl sm:text-3xl font-extrabold text-slate-900 font-sans mt-0.5">
                  {totalCount}
                </div>
              </div>
            </div>
        ...
        {[
          {
            ...
            count: evidenceList.filter((e) => e.evidence_type === "image").length,
            icon: Camera,
          ...
          },
          {
            ...
            count: evidenceList.filter((e) => e.evidence_type === "video").length,
            icon: Video,
          ...
          },
          {
            ...
            count: evidenceList.filter((e) => e.evidence_type === "audio").length,
            icon: Mic,
          ...
          },
          {
            ...
            count: evidenceList.filter((e) => e.evidence_type === "digital_document" || e.evidence_type === "forensic_artifact").length,
            icon: FileText,
          ...
          <div
            ...
            className={cn(
              "group flex items-center justify-between p-3.5 rounded-2xl bg-white border border-slate-200/90 hover:border-blue-400 hover:shadow-md transition-all cursor-pointer shadow-sm",
              typeFilter === cat.type && "border-blue-600 ring-2 ring-blue-600/20 bg-blue-50/20"
            )}
          >
            <div className="flex items-center gap-3">
              <div className={cn("p-2.5 rounded-xl border shrink-0", cat.iconColor)}>
      ...
      {/* Security Callout Banner (Reference Panel 6) */}
      <div className="flex items-center gap-3 p-3.5 rounded-2xl border border-blue-200 bg-blue-50/60 text-xs text-blue-900 shadow-sm">
        <div className="p-2 rounded-xl bg-blue-600 text-white shrink-0">
          <Shield className="h-4 w-4" />
        </div>
        <p className="text-xs font-medium leading-relaxed">
          All evidence is cryptographically protected and stored in a secure vault with immutable SHA-256 custody chaining.
        </p>
      </div>
