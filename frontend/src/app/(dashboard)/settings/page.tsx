...
export default function SettingsPage() {
  ...
  // Active settings tab for mobile & desktop navigation
  const [activeSection, setActiveSection] = useState<
    "user_management" | "security_access" | "notifications" | "audit_logs" | "backup_restore" | "system_info"
  >("security_access");
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200 pb-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Security policies, user administration, and cryptographic audit ledger controls.
          </p>
        </div>

        <Badge variant="outline" className="w-fit font-mono text-[10px] text-blue-700 bg-blue-50 border-blue-200 uppercase">
          Zero-Trust Scoped
        </Badge>
      </div>

      {/* Settings Navigation List (Reference Panel 8) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {[
          {
            id: "user_management" as const,
            label: "User Management",
            desc: "Officer accounts & RBAC",
            icon: Users,
            badge: hasRole("system_admin") ? "Admin" : "Scoped",
            color: "text-blue-600 bg-blue-50 border-blue-100",
          },
          {
            id: "security_access" as const,
            label: "Security & Access",
            desc: "Credentials, Argon2id & session",
            icon: Lock,
            badge: "Active",
          ...
          },
          {
            ...
            label: "Notifications",
            desc: "Security alerts & broadcast",
            icon: Shield,
            badge: "Enforced",
          ...
          },
          {
            ...
            label: "Audit Logs",
            desc: "SHA-256 hash-chain verification",
            icon: ShieldCheck,
            badge: "Chained",
          ...
          },
          {
            ...
            desc: "MinIO S3 object store sync",
            icon: RefreshCw,
            badge: "Automated",
            color: "text-amber-600 bg-amber-50 border-amber-100",
          },
          {
            id: "system_info" as const,
            label: "System Information",
            desc: "Sec. 63/65B BSA compliance",
            icon: Key,
            badge: "v2.1.0",
          ...
          <button
            ...
            className={cn(
              "flex items-center justify-between p-4 rounded-2xl bg-white border border-slate-200/90 text-left transition-all shadow-sm hover:shadow-md hover:border-blue-400 group",
              activeSection === item.id && "border-blue-600 ring-2 ring-blue-600/20 bg-blue-50/20"
            )}
          >
      ...
      {/* System Status Banner (Reference Panel 8) */}
      <div className="flex items-center justify-between p-4 rounded-2xl border border-emerald-200 bg-emerald-50/50 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-emerald-700/90 font-medium">
              All systems operational &bull; Zero integrity discrepancies detected
            </p>
          </div>
        </div>

        <span className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-[10px] font-bold font-mono">
